    ...
    return (
      ...
      >
        ...
        <Helmet>
          ...
          <meta
            name="keywords"
            content="experience, career, professional journey, work history, companies, roles"
          />
          <meta property="og:title" content="Professional Experience" />
          <meta
            property="og:description"
            content="A detailed timeline of my career, roles, and contributions."
          />
          <meta property="og:type" content="website" />
          <meta property="og:url" content="https://yourdomain.com/experience" />
          <meta
            property="og:image"
            content={experiences[0]?.logo || "/default-image.jpg"}
          />
        </Helmet>
